...
import { Users, FileText, HelpCircle, TrendingUp, Play, ArrowRight } from 'lucide-react';
import HeroIllustration from './HeroIllustration';

const stats = [
  { label: 'Students', value: 1000000, suffix: '+', icon: Users, color: 'text-primary' },
  { label: 'Mock Tests', value: 5000, suffix: '+', icon: FileText, color: 'text-cat-ssc' },
  { label: 'Questions', value: 5000000, suffix: '+', icon: HelpCircle, color: 'text-cat-railways' },
  { label: 'Success Rate', value: 94, suffix: '%', icon: TrendingUp, color: 'text-cat-defence' },
];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.p variants={itemVariants} className="text-lg text-gray-600 mb-8 max-w-xl mx-auto lg:mx-0">
              India's most comprehensive exam preparation platform. Practice with{' '}
              <span className="font-semibold text-gray-900">AI-powered mock tests</span>,{' '}
              detailed analytics, and 5000+ tests across Banking, SSC, Railways, UPSC & more.
            </motion.p>
