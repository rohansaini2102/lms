...
const TestSeries: React.FC = () => {
  const testSeriesData: Omit<TestSeriesCardProps, 'index'>[] = [
    {
      title: 'SBI PO Complete Test Series 2025',
      exam: 'SBI PO',
      tests: 150,
      duration: '6 months',
      students: '45K+',
    ...
    {
      title: 'SSC CGL Tier 1 + Tier 2 Combo',
      exam: 'SSC CGL',
      tests: 200,
      duration: '12 months',
      students: '78K+',
    ...
    {
      title: 'RRB NTPC CBT 1 & 2 Mock Tests',
      exam: 'RRB NTPC',
      tests: 180,
      duration: '6 months',
      students: '62K+',
    ...
    {
      title: 'UPSC CSE Prelims Test Series',
      exam: 'UPSC CSE',
      tests: 100,
      duration: '12 months',
      students: '25K+',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="font-grotesk font-bold text-3xl sm:text-4xl text-gray-900 mb-4">
            Top Test Series for 2025
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Join thousands of aspirants preparing with our comprehensive test series.
            Get exam-pattern based mocks with detailed solutions.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-gradient-to-r from-primary to-primary-dark rounded-2xl p-8 lg:p-10 text-white text-center"
        >
          <h3 className="font-grotesk font-bold text-2xl lg:text-3xl mb-3">
            Can't find your exam?
          </h3>
          <p className="text-white/80 mb-6 max-w-xl mx-auto">
            We have 5000+ mock tests across 50+ government exams. Browse our complete catalog.
          </p>
          <motion.button
