...
const Features: React.FC = () => {
  const benefits = [
    ...
    'Practice in Hindi or English',
    'Works on all devices',
    '2025 exam patterns covered',
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="font-grotesk font-bold text-3xl sm:text-4xl text-gray-900 mb-6">
              Smart Features for{' '}
              <span className="text-primary">Smarter Preparation</span>
            </h2>
            <p className="text-gray-600 mb-8">
              Our platform combines cutting-edge AI technology with proven exam preparation
              strategies to help you succeed in any government exam.
            </p>
